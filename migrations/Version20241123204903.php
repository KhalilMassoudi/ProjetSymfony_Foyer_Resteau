 ...
 */
final class Version20241123204903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_reclamation CHANGE nom_type_reclamation nom_type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE type_reclamation CHANGE nom_type nom_type_reclamation VARCHAR(255) NOT NULL');
    }
}
